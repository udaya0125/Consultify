...
const services = [
    {
        ...
        description:
            "Get expert guidance to choose the right career path and educational opportunities abroad.",
    ...
    },
    {
        ...
        description:
            "Assistance in applying to top universities worldwide with personalized application support.",
    ...
    },
    {
        ...
        description:
            "Comprehensive support in student visa application and documentation.",
    ...
    },
    {
        ...
        description:
            "Preparation courses for IELTS, TOEFL, GRE, GMAT, and other international exams.",
    ...
    },
    {
        ...
        description:
            "Explore a wide range of study programs in Canada, Australia, UK, and more.",
    ...
    },
    {
        ...
        description:
            "Get orientation and travel support before starting your international journey.",
        ...
        <div className="w-full min-h-screen py-12">
            ...
            <div className="pt-20 pb-16 bg-white">
                <div className="text-center px-6">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Transform your dreams into reality with our
            ...
            <div className="px-6 md:px-20 lg:px-32">
                ...
                <div className="flex justify-center mt-5">
                    <Link
                        href={`/contact`}
                        className="bg-red-600 text-white cursor-pointer py-3 px-6 rounded-lg font-medium hover:bg-red-700 transition-colors duration-200 flex items-center justify-center gap-2"
                    >
                        Contact Us
                    ...
                    <div className="text-center px-6">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <p className="text-lg mb-8 max-w-2xl mx-auto">
                                ...
                                today and let us help you achieve your education
                                dreams abroad.
                            </p>
