...
const university = [
    {
        ...
        description:
            "Find the best universities in Australia with rank dataset extracted from Top Universities Worldwide",
    },
    {
    ...
    return (
        <div className="w-full px-4 lg:px-24 py-12">
            <div className="mb-8 flex justify-between">
                ...
                <button className="bg-red-600 hover:bg-red-700 px-4 py-3 shadow-md rounded-lg text-white">
                    View More
                </button>
            </div>
